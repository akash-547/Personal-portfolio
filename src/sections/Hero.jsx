...
import { 
  ...
  ArrowRight, 
  ChevronDown 
} from "lucide-react"; // Saare icons ek hi line mein combine kar diye
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="space-y-8">
            ...
            <div className="flex items-center gap-4 animate-fade-in animation-delay-400">
              ...
              {[
                { icon: Github, href: "https://github.com/akash-547" },
                { icon: Linkedin, href: "https://www.linkedin.com/in/akash-hussain-7902533b2" },
                { icon: SiUpwork, href: "https://www.upwork.com/freelancers/~013ee400aa03ad2bc8" },
              ].map((social, idx) => (
                <a
                  key={idx}
                  href={social.href}
